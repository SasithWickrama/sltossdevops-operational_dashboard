  ...
  <div class="container-fluid mt-5">
    ...
    <div class="row wow fadeIn">
      ...
      <div class="card-header text-center">                  
              <h5 style="font-weight: bold;">Region Level- Pending Faults Distribution (OPMC WG Only)</h5>
                </div>
	   ...
	   <div class="row wow fadeIn">
        ...
        <!--Grid column-->
          ...
          <div class="row wow fadeIn">
            ...
            <div class="col-md-12 mb-4">
              ...
              <div class="card" >
              <div class="card-header text-center">                  
              <h5 style="font-weight: bold;">Cleared faults & Pending faults as of now</h5>
                </div>
                <!--Card content-->
                <div class="card-body">
                  <div id="pendingflts" ></div>
        ...
        <div class="row wow fadeIn">
            ...
            <div class="col-md-12 mb-4">
              ...
              <div class="card" >
              <div class="card-header text-center">                  
              <h5 style="font-weight: bold;">Cleared faults & Pending faults as of now with Service Type</h5>
                </div>
                <!--Card content-->
                <div class="card-body">
                  <div id="pendingfltsx"  align="center"></div>
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="card">
			<div class="card-header text-center">
      <h5 style="font-weight: bold;">Reported Faults</h5>
            </div>
            <!--Card content-->
            <div class="card-body">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="card mb-4">
            <!-- Card header -->
            <div class="card-header text-center">
            <h5 style="font-weight: bold;"> Cleared Faults</h5>
            </div>
            <!--Card content-->
            <div class="card-body">
    ...
    <div class="row wow fadeIn">
      ...
      <div class="card-header text-center">
      <h5 style="font-weight: bold;"> LEA level- Faults Counts</h5>
      </div>
...
$.ajax({
   type: "POST",
   url: "./api_R_rtom.php?apicall=pendingflts1",
   success: function(res){
    if(res != ''){
      var tbl = "<table  style=\"width:50%\" align=\"center\" ><tr><td>DGM Area</td><td >OPMC</td><td align=\"center\">Cleared Fault Count</td><td align=\"center\">Pending Fault Count</td></tr>";
      var region ="";
      var pending = 0; var closed = 0;
      for(var i =0;  i<res['reply']['PROVINCE'].length; i++){
        if ( region !== "" && region !== res['reply']['PROVINCE'][i]){
          tbl += "<tr><td colspan=\"2\">"+region+" TOTAL</td><td align=\"center\">"+
          closed+"</td><td align=\"center\">"+pending+"</td></tr>";
          pending = 0;  closed = 0;
        }
        tbl += "<tr><td>"+res['reply']['PROVINCE'][i]+"</td><td>"+res['reply']['OPMC_NAME'][i]+"</td><td align=\"center\">"+
        res['reply']['CLEARED'][i]+"</td><td "; if(res['reply']['PENDING'][i] == "0"){tbl +=" bgcolor=\"#29a329\" "} tbl +="align=\"center\">"+res['reply']['PENDING'][i]+"</td></tr>";
        region= res['reply']['PROVINCE'][i];
        pending += parseInt(res['reply']['PENDING'][i]);
        closed += parseInt(res['reply']['CLEARED'][i]);
...
$.ajax({
   type: "POST",
   url: "./api_R_rtom.php?apicall=pendingfltsx",
   success: function(res){
    if(res != ''){
      var tbl = "<table >"
      +"<tr><td colspan=\"2\" align=\"center\"></td><td colspan=\"2\">MEGALINE</td>"
      +"<td colspan=\"2\" align=\"center\">BROADBAND</td>"
      +"<td colspan=\"2\" align=\"center\">PEOTV</td>"
      +"<td colspan=\"2\" align=\"center\">FTTH</td>"
      +"<td colspan=\"2\" align=\"center\">LTE</td>"
      +"<td colspan=\"2\" align=\"center\">DATA</td></tr>"
      +"<tr><td>DGM Area</td><td>OPMC</td>"
      +"<td  align=\"center\">Cleared</td><td  align=\"center\">Pending</td>"
      +"<td  align=\"center\">Cleared</td><td  align=\"center\">Pending</td>"
      +"<td  align=\"center\">Cleared</td><td  align=\"center\">Pending</td>"
      +"<td  align=\"center\">Cleared</td><td  align=\"center\">Pending</td>"
      +"<td  align=\"center\">Cleared</td><td  align=\"center\">Pending</td>"
      ...
      for(var i =0;  i<res['reply']['PROVINCE'].length; i++){
        // if ( region !== "" && region !== res['reply']['PROVINCE'][i]){
        //   tbl += "<tr><td colspan=\"2\">"+region+" TOTAL</td><td>"+
        //   closed+"</td><td>"+pending+"</td></tr>";
        //   pending = 0;  closed = 0;
        // }
        tbl += "<tr><td>"+res['reply']['PROVINCE'][i]+"</td><td>"+res['reply']['OPMC_NAME'][i]+"</td>"
      +"<td  align=\"center\">"+res['reply']['CLEARED_MEGALINE'][i]+"</td><td "; if(res['reply']['PENDINGS_MEGALINE'][i] == "0"){tbl +=" bgcolor=\"#29a329\" "} tbl +="align=\"center\">"+res['reply']['PENDINGS_MEGALINE'][i]+"</td>"
      +"<td  align=\"center\">"+res['reply']['CLEARED_BROADBAND'][i]+"</td><td "; if(res['reply']['PENDINGS_BROADBAND'][i] == "0"){tbl +=" bgcolor=\"#29a329\" "} tbl +=" align=\"center\">"+res['reply']['PENDINGS_BROADBAND'][i]+"</td>"
      +"<td  align=\"center\">"+res['reply']['CLEARED_PEOTV'][i]+"</td><td "; if(res['reply']['PENDINGS_PEOTV'][i] == "0"){tbl +=" bgcolor=\"#29a329\" "} tbl +=" align=\"center\">"+res['reply']['PENDINGS_PEOTV'][i]+"</td>"
      +"<td  align=\"center\">"+res['reply']['CLEARED_FTTH'][i]+"</td><td "; if(res['reply']['PENDINGS_FTTH'][i] == "0"){tbl +=" bgcolor=\"#29a329\" "} tbl +=" align=\"center\">"+res['reply']['PENDINGS_FTTH'][i]+"</td>"
      +"<td  align=\"center\">"+res['reply']['CLEARED_LTE'][i]+"</td><td "; if(res['reply']['PENDINGS_LTE'][i] == "0"){tbl +=" bgcolor=\"#29a329\" "} tbl +=" align=\"center\">"+res['reply']['PENDINGS_LTE'][i]+"</td>"
      +"<td  align=\"center\">"+res['reply']['CLEARED_DATA'][i]+"</td><td  "; if(res['reply']['PENDINGS_DATA'][i] == "0"){tbl +=" bgcolor=\"#29a329\" "} tbl +="align=\"center\">"+res['reply']['PENDINGS_DATA'][i]+"</td>"
      +"</tr>";
        region= res['reply']['PROVINCE'][i];
        //pending += parseInt(res['reply']['PENDING'][i]);
       // closed += parseInt(res['reply']['CLEARED'][i]);
      ...
      // tbl += "<tr><td colspan=\"2\"><h6>"+region+" TOTAL</h6></td><td><h6>"+
      //     closed+"</h6></td><td><h6>"+pending+"</h6></td></tr>";
      tbl += "</table>";	
      
      $("#pendingfltsx").append(tbl);
    }
