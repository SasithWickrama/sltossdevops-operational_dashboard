  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar" style="background-image: linear-gradient(to right,#f4ecf7,#d4e6f1);">
    <div class="container-fluid">
      ...
      <a class="navbar-brand waves-effect" style="margin-left:5%">
        <strong class="blue-text" >RTSU- Operational Management Dashboard-&nbsp;<?php echo $username; ?></strong>
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=pendingbox1",
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=pendingboxpri",
   success: function(res){
  if(res != ''){
    console.log(res);
    var elements = document.getElementsByClassName('a');
  ...
  $.ajax({
   type: "POST",
   url: "./api_C.php?apicall=repfsummary",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=faultnew",
   success: function(res){
  if(res != ''){
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=rtomfault",
   success: function(res){
  if(res != ''){
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=totcount",
   success: function(res){
  if(res != ''){
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=repetedfaults2",
   success: function(res){
  if(res != ''){
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=provincetot",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=regiontot",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=repfaults",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=clerdfaults",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./api_C.php?apicall=pendingflts",
   success: function(res){
...
function viewData(){
  ...
  var id = event.target.id.replace("D", "");  
   $.ajax({
     type: "POST",
     url: "./api_C.php?apicall=repetedfaultsdetails",
     data:{id:id},
     success: function(res){
 ...
 function viewData1(){
  ...
  var id = event.target.id.replace("D", "");  
   $.ajax({
     type: "POST",
     url: "./api_C.php?apicall=repetedfaultsdetails2",
     data:{id:id},
     success: function(res){
 ...
 $.ajax({
   type: "POST",
   url: "./api_C.php?apicall=boxfaultsdetails",
 ...
 $.ajax({
   type: "POST",
   url: "./api_C.php?apicall=boxfaultsdetailspri",
   data:{type:type,time:time},
   success: function(res){
  if(res != ''){
