...
$result="";
  ...
  $sql="SELECT DISTINCT RTOM_CODE FROM SLT_AREA WHERE REGIONS='$region'";
...
$result="";
  ...
  $sql=" SELECT DISTINCT PROVINCE FROM SLT_AREA WHERE REGIONS='$region'";
  $stid =oci_parse($CON,$sql);
  oci_execute($stid);
  ...
  //---------------------------------------- megaline ----------------------------------------------//
   ...
   $sql1="SELECT COUNT(PROM_NUMBER) AS PROB_COUNT  FROM OSS_FAULTS.REALTIME_FAULTS  
    ...
    if(isset($_POST['province'])){
        ...
        $sql1.= " and PROM_REGN_CODE in (SELECT LEA_CODE FROM SLT_AREA  WHERE PROVINCE = '$province')";
  ...
  //-----------------------------------------broadband--------------------------------------------------//
   ...
   $sql2="SELECT COUNT(PROM_NUMBER) AS PROB_COUNT  FROM OSS_FAULTS.REALTIME_FAULTS  
    ...
    if(isset($_POST['province'])){
        ...
        $sql2.= "and PROM_REGN_CODE in (SELECT LEA_CODE FROM SLT_AREA  WHERE PROVINCE = '$province')";
...
//-----------------------------------------------PeoTV----------------------------------------------//
   ...
   $sql3="SELECT COUNT(PROM_NUMBER) AS PROB_COUNT  FROM OSS_FAULTS.REALTIME_FAULTS  
    ...
    if(isset($_POST['province'])){
        ...
        $sql3.= "and PROM_REGN_CODE in (SELECT LEA_CODE FROM SLT_AREA  WHERE PROVINCE = '$province')";
...
WHERE PROM_CLEARED IS NULL AND  CIRT_SERT_ABBREVIATION in ('V-VOICE FTTH','AB-FTTH','E-IPTV FTTH','BB-INTERNET FTTH')";
    ...
    if(isset($_POST['province'])){
        ...
        $sql4.= "and PROM_REGN_CODE in (SELECT LEA_CODE FROM SLT_AREA  WHERE PROVINCE = '$province')";
...
//----------------------------------------------LTE-----------------------------------------//
 ...
 $sql5="SELECT COUNT(PROM_NUMBER) AS PROB_COUNT  FROM OSS_FAULTS.REALTIME_FAULTS  
    ...
    if(isset($_POST['province'])){
        ...
        $sql5.= "and PROM_REGN_CODE in (SELECT LEA_CODE FROM SLT_AREA  WHERE PROVINCE = '$province')";
  ...
  //----------------------------------------------DATA-----------------------------------------//
   ...
   $sql6="SELECT COUNT(PROM_NUMBER) AS PROB_COUNT  FROM OSS_FAULTS.REALTIME_FAULTS  
    ...
    if(isset($_POST['province'])){
        ...
        $sql6.= "and PROM_REGN_CODE in (SELECT LEA_CODE FROM SLT_AREA  WHERE PROVINCE = '$province')";
  ...
  // ------------------------------------------------total-------------------------------------------
    ...
    //if(isset($_POST['province'])){
        ...
        //$sql7.= "and PROM_REGN_CODE in (SELECT LEA_CODE FROM SLT_AREA  WHERE PROVINCE = '$province')";
