    ...
    <div class="row wow fadeIn">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" style="width: 50%;">
          <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Region Level-  Pending Faults Distribution</a>
        </li>
        <li class="nav-item" style="width: 50%;">
          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Province & RTOM Level-  Pending Faults Distribution</a>
        </li>
      </ul>
...
$.ajax({
   type: "POST",
   url: "./api_R.php?apicall=pendingbox1",
...
$.ajax({
   type: "POST",
   url: "./api_R.php?apicall=pendingboxpri",
   success: function(res){
	if(res != ''){
		console.log(res);
		var elements = document.getElementsByClassName('a');
	...
	$.ajax({
   type: "POST",
   url: "./api_R.php?apicall=repfsummary",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./api_R.php?apicall=faultnew",
   success: function(res){
  if(res != ''){
...
$.ajax({
   type: "POST",
   url: "./api_R.php?apicall=totcount",
   success: function(res){
  if(res != ''){
...
$.ajax({
   type: "POST",
   url: "./api_R.php?apicall=repetedfaults2",
   success: function(res){
  if(res != ''){
...
$.ajax({
   type: "POST",
   url: "./api_R.php?apicall=provincetot",
   success: function(res){
     console.log('xxxxxxx');
     console.log(res);
  var dataArr = new Array();
...
$.ajax({
   type: "POST",
   url: "./api_R.php?apicall=repfaults",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./api_R.php?apicall=clerdfaults",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./api_R.php?apicall=pendingflts",
   success: function(res){
...
function viewData(){
   ...
   $.ajax({
	   type: "POST",
	   url: "./api_R.php?apicall=repetedfaultsdetails",
	   data:{id:id},
	   success: function(res){
 ...
 function viewData1(){
  ...
  var id = event.target.id.replace("D", "");  
   $.ajax({
     type: "POST",
     url: "./api_R.php?apicall=repetedfaultsdetails2",
     data:{id:id},
     success: function(res){
 ...
 $.ajax({
   type: "POST",
   url: "./api_R.php?apicall=boxfaultsdetails",
 ...
 $.ajax({
   type: "POST",
   url: "./api_R.php?apicall=boxfaultsdetailspri",
   data:{type:type,time:time},
   success: function(res){
  if(res != ''){
