    ...
    <div class="row wow fadeIn">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" style="width: 50%;">
          <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Province Level- Pending Faults Distribution</a>
        </li>
        <li class="nav-item" style="width: 50%;">
          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">RTOM Level- Pending Faults Distribution</a>
        </li>
      </ul>

      <!-- Tab panes -->
      <!--<div class="tab-content" style="background-color:#1a5276;">-->
    ...
    <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">
		...
		<!--Grid column-->
            <div class="col-md-6 mb-4">
              ...
              <div class="card" >
              <div class="card-header text-center">
                  Service Type Level- Faults Count
                  <input type="text"  style="display: none;" name="province" id="province" value="<?php echo  htmlentities($username);?>" >
                </div>
                <!--Card content-->
...
$.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=pendingbox1",
...
$.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=pendingboxpri",
   success: function(res){
	if(res != ''){
		console.log(res);
		var elements = document.getElementsByClassName('a');
	...
	$.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=repfsummary",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=faultnew",
   success: function(res){
  if(res != ''){
...
$.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=totcount",
   success: function(res){
  if(res != ''){
...
$.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=repetedfaults2",
   success: function(res){
  if(res != ''){
...
$.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=rtomtot",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=repfaults",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=clerdfaults",
   success: function(res){
...
$.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=pendingflts",
   success: function(res){
...
function viewData(){
   ...
   $.ajax({
	   type: "POST",
	   url: "./apirtom.php?apicall=repetedfaultsdetails",
	   data:{id:id},
	   success: function(res){
 ...
 function viewData1(){
  ...
  var id = event.target.id.replace("D", "");  
   $.ajax({
     type: "POST",
     url: "./apirtom.php?apicall=repetedfaultsdetails2",
     data:{id:id},
     success: function(res){
 ...
 $.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=boxfaultsdetails",
 ...
 $.ajax({
   type: "POST",
   url: "./apirtom.php?apicall=boxfaultsdetailspri",
   data:{type:type,time:time},
   success: function(res){
  if(res != ''){
...
var htmls = "";
            ...
            var link = document.createElement("a");
            link.download = "LEA level-Faults Counts-province.xls";
            link.href = uri + base64(format(template, ctx));
            link.click();
}
